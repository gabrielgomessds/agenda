...
function str_slug(string $string): string
{
    ...
    $replace = 'aaaaaaaceeeeiiiidnoooooouuuuuybsaaaaaaaceeeeiiiidnoooooouuuyybyr                                 ';

    $slug = str_replace(["-----", "----", "---", "--"], "-",
        str_replace(" ", "-",
            trim(strtr(iconv('UTF-8', 'ISO-8859-1', $string), iconv('UTF-8', 'ISO-8859-1', $formats), $replace))
        )
    );
    return $slug;
}
...
function str_limit_words(string $string, int $limit, string $pointer = "..."): string
{
    ...
    $string = trim(filter_var(iconv('UTF-8', 'ISO-8859-1', $string)));
